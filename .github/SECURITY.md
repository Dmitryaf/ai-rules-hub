...
Проект находится на ранней стадии и не публикует стабильные releases. Security fixes при необходимости вносятся только в актуальную ветку `main`.

## Как сообщить об уязвимости

Не публикуйте секреты, exploit details или приватные данные в обычном issue, pull request или comment.
