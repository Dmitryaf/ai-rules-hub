...
Для средней или большой задачи веди короткий план с одним активным пунктом. Сначала проверь `git status`, сохрани чужие изменения и отдели изменение правил от несвязанных правок структуры.

После изменения структуры, ссылок или состава правил выполни:
