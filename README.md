...
3. Заполните созданные локальные документы:
   ...
   На данный момент лучшим варинантом будет сразу перейти к шагам 4 и 5, а затем дать модели промпт для анализа правил хаба и правил, которые уже существуют в проекте, чтобы избежать дублирование или явных противоречий в правилах. В промпте так же стоит указать, чтобы нейронка разделила специфичные правила самого проекта от правил хаба
