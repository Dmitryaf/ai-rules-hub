...
Профиль — всегда читаемая надстройка над baseline для устойчивого свойства проекта. Он содержит назначение и уникальные обязательства, но не дублирует тематические правила. Сочетание profiles не является наследованием или зависимостью между ними.
