...
Шаблон не определяет публичность результата. Внутренний или личный документ размещается в принятом локальном либо закрытом пространстве проекта и не добавляется в tracked-поверхность только из-за наличия шаблона в хабе.
